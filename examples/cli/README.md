...
run a JS-based component targetting version `0.3.0` of the [wasi-cli] `command`
world.
...
```
componentize-js -d ../../wit -w wasi:cli/command@0.3.0 componentize app.js -o cli.wasm
